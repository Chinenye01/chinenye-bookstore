...
//        myPrice = thePrice;
     ...
     * @throws IllegalArgumentException if thePrice is less than Zero
     * @throws IllegalArgumentException if theBulkPrice is less than Zero
     * @throwsIllegalArgumentException if theBulkQuantity is less than Zero
     */
    public Item(final String theName, final BigDecimal thePrice, final int theBulkQuantity,
        ...
        if(theBulkQuantity <0) {
            throw new IllegalArgumentException("The bulk quantity must be greater than Zero");
        }
        if(theBulkPrice.compareTo(BigDecimal.ZERO)<0) {
            throw new IllegalArgumentException("The bulk price must be greater than or equal to zero");
        }
        myName = Objects.requireNonNull(theName);
        myPrice = thePrice;
